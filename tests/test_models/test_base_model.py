...
class TestBaseModel(unittest.TestCase):
    ...
    def test_attr_check(self):
        ...
        self.b1.name = "Serah"
        self.b2.name = "Duan"
        self.assertEqual(self.b1.name, "Serah")
        self.assertEqual(self.b2.name, "Duan")
    ...
    def test_change_name(self):
        ...
        self.b2.name = "Duan"
        self.b1.name = "Mundia"
        self.assertTrue(self.b1.name, "Mundia")
        self.assertTrue(self.b2.name, "Duan")
