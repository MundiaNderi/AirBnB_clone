...
class TestUser(unittest.TestCase):
    ...
    def test_setting_attributeValues(self):
        ...
        self.a.first_name = "Serah"
        self.a.last_name = "Nderi"
        self.a.email = "serah@test.com"
        self.a.password = "pass"
        self.assertTrue(self.a.first_name, "Serah")
        self.assertTrue(self.a.last_name, "Nderi")
        self.assertTrue(self.a.email, "serah@test.com")
    ...
    def test_attribute_and_values(self):
        ...
        for k, v in attributes.items():
            self.assertTrue(hasattr(sarah, k))
            self.assertEqual(type(getattr(sarah, k, None)), v)
